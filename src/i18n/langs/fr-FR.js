export default {
  ...
  features: {
    ...
    cards: {
      free: {
        title: 'Coût zéro',
        desc: 'Convertisseur de documents AI totalement gratuit, sans limite d\'utilisation ni inscription requise.'
      },
      quality: {
        title: 'Qualité supérieure',
        desc: 'Propulsé par Claude AI, garantissant des résultats de conversion de la plus haute qualité.'
      },
      smart: {
  ...
  testimonials: {
    title: 'Ce que disent les utilisateurs de DocSmart',
    subtitle: 'Écoutez les créateurs et les professionnels qui utilisent notre convertisseur de documents AI au quotidien.',
    list: [
      {
        name: 'Pierre Dubois',
        title: 'Ingénieur en Documentation Technique',
        text: 'DocSmart a révolutionné notre processus de documentation. La conversion AI est incroyablement précise et nous fait gagner d\'innombrables heures.',
        avatar: ''
      },
      {
        name: 'Marie Laurent',
        title: 'Chercheuse Universitaire',
        text: 'La capacité à maintenir un formatage complexe lors de la conversion de documents académiques est inestimable. DocSmart comprend parfaitement la structure du document.',
        avatar: ''
      },
      {
        name: 'Thomas Bernard',
        title: 'Consultant en Gestion',
        text: 'DocSmart optimise notre flux de travail en convertissant rapidement les documents des clients tout en maintenant leur apparence professionnelle.',
        avatar: ''
      },
      {
        name: 'Sophie Martin',
        title: 'Administratrice de Dossiers Médicaux',
        text: 'La précision et les fonctionnalités de sécurité de DocSmart en font l\'outil parfait pour gérer la documentation médicale sensible.',
        avatar: ''
      },
      {
        name: 'Jean Petit',
        title: 'Conseiller Juridique',
        text: 'La qualité de conversion et la préservation du format de DocSmart sont essentielles pour nos besoins en matière de traitement des documents juridiques.',
        avatar: ''
      }
    ]
  },
